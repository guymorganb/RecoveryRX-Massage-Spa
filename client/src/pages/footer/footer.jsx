...
export const Footer = () => {
  ...
  return (
    ...
    justify="center" 
    textAlign="center"> <i> Testimonials Comming Soon</i>
      <Box bgColor="#ffffff">
        <Box bgColor="#5e6d55" > 
          <Text color="#ffffff" 
          fontSize="64px" 
          ...
          <Box mx="auto" my="4">
            ...
            <Image src="https://images.unsplash.com/photo-1534447677768-be436bb09401?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1788&q=80" 
            alt="Some Image" 
            boxSize="30vh" 
            width="90vw" 
            mx="auto"
